...
class _MyCalendarState extends State<MyCalendar> {
  ...
  //find remaining days
  int remainingDays(String startDate) {
    final difference = DateTime.parse(startDate).difference(selectedDay);
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //if selected date has no event or booking show featured event
                            for (var j = 0; j < events.length; j++)
                              for (var i = 0; i < bookings.length; i++)
                                if (bookings.elementAt(i).eventId ==
                                        events.elementAt(j).id &&
                                          ...
                                          child: SingleChildScrollView(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text(remainingDays(events
                                                            .elementAt(j)
                                                            .startDate
                                                            .toString())
                                                        .toString() +
                                                    " Gün sonra ${events.elementAt(j).name}'na biletiniz var !"),
                                              ],
                                            ),
                                          ),
                                        ),
